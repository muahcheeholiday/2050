...
export default function Home() {
  ...
  return (
    <div className="relative min-h-dvh w-full overflow-hidden">
      ...
      <div className="relative z-10 min-h-dvh flex flex-col justify-end px-6 pb-10 pt-24 sm:px-12 sm:pb-16 max-w-4xl mx-auto">
        <div className="absolute top-6 left-6 sm:top-10 sm:left-12 flex items-center gap-3">
          <div className="w-2 h-8 bg-yellow-400" />
        ...
        <h1 className="font-headline font-bold uppercase text-3xl sm:text-5xl leading-tight mb-4 sm:mb-6 max-w-2xl">
          {scene.title}
        </h1>

        <p className="text-base sm:text-lg leading-relaxed text-neutral-200 max-w-2xl mb-8 sm:mb-10">
          {scene.narrative}
        </p>
